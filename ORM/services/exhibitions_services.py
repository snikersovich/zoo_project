...
class ExhibitionsService:
    ...
    def create_exhibitions(self, events_date: int, events_time: int, events_name: str) -> Exhibitions:
    ...
    def update_exhibitions(self, events_id: int, events_date: int = None, events_time: int = None,
