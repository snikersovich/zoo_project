...
class ExcursionService:
    ...
    def create_excursion(self, events_date: int, events_time: int, events_name: str) -> Excursions:
    ...
    def update_excursion(self, events_id: int, events_date: int, events_time: int, events_name: str) -> Excursions:
