...
class OpenFeedingService:
    ...
    def create_open_feeding(self, events_date: int, events_time: int, events_name: str) -> Open_feeding:
    ...
    def update_open_feeding(self, events_id: int, events_date: int, events_time: int, events_name: str) -> Open_feeding:
