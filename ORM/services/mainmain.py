...
def main():
    ...
    try:
        ...
        excursion_services.create_excursion("23.12", "12:30", "Маленькое кругосветное путешествие")
        excursion_services.create_excursion("25.12", "16:00", "Новый год среди животных")
        excursion_services.create_excursion("07.01", "12:30", "Рождественское прикоючение")
        excursion_services.create_excursion("14.01", "12:30", "Среди животных")

        exhibitions_services = ExhibitionsService(db)

        exhibitions_services.create_exhibitions("24.12", "13:30", "Выступлние медведя Евгения")
        exhibitions_services.create_exhibitions("26.12", "11:30", "Удивительные Амурские тигры")
        exhibitions_services.create_exhibitions("08.01", "14:00", "Дебют Ильи Курбанова на сцене")
        exhibitions_services.create_exhibitions("15.01", "13:30", "Мертвая петля попугая Кеши")
        exhibitions_services.create_exhibitions("18.01", "13:30", "Медведь Евгений vs Илья Курбанов.Профессиональный бокс")

        open_feeding_services = OpenFeedingService(db)
        open_feeding_services.create_open_feeding("22.12", "8:00", "Кормление льва")
        open_feeding_services.create_open_feeding("22.12", "8:00", "Кормление зебр")
        open_feeding_services.create_open_feeding("22.12", "8:10", "Кормление жирафа")
        open_feeding_services.create_open_feeding("22.12", "8:10", "Кормление медведей")
        open_feeding_services.create_open_feeding("22.12", "8:20", "Кормление обезьян")
        open_feeding_services.create_open_feeding("22.12", "8:20", "Кормление слона")
        open_feeding_services.create_open_feeding("22.12", "8:30", "Кормление тигров")
        open_feeding_services.create_open_feeding("22.12", "8:30", "Кормление антилоп")
        open_feeding_services.create_open_feeding("22.12", "8:40", "Кормление попугаев")
        open_feeding_services.create_open_feeding("22.12", "8:40", "Кормление крокадила")
