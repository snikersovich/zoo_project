...
from adminWin import on_button_excursions_clicked
from adminWin import on_button_open_feeding_clicked
from adminWin import on_button_exhibitions_clicked
...
class UserWin(QWidget):
    ...
    def open_feefing_menu(self):
        on_button_open_feeding_clicked()

    def open_excursions_menu(self):
        on_button_excursions_clicked()

    def open_exhibitions_menu(self):
        on_button_exhibitions_clicked()
